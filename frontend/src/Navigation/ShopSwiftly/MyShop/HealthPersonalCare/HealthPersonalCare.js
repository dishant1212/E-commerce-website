...
import { fetchData } from "../../../../redux/slices/healthProducts";
...
function HealthPersonalCare(){
   ...
   const HealthPersonalCare=useSelector(state=>state.healthProducts)
...
function proccedToBuyHandler(){
  if(signInData.data){
   ...
   useEffect(()=>{
    ...
    return(
        <div>
        <h2>HealthPersonalCare</h2>
        <div className="container">
          {HealthPersonalCare.data.map(item => (
